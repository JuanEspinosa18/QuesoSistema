...
from cart.views import carrito, eliminar_producto, restar_producto, limpiar_carrito, agregar_al_carrito, procesar_pedido, mis_pedidos, cancelar_pedido, perfil_cliente, enviar_correo_pedido_admin
