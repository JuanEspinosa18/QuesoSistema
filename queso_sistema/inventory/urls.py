...
urlpatterns = [
    ...
    path('agregar_materiaPrima/', views.agregar_materia_prima, name='agregar_materia_prima'),
    path('eliminar_materiaPrima/<int:id>/', views.eliminar_materia_prima, name='eliminar_materia_prima'),
    path('editar_materiaPrima/<int:id>/', views.editar_materia_prima, name='editar_materia_prima'),
